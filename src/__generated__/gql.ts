 ...
 */
type Documents = {
  '\n  query GetCharactersTable($page: Int, $filter: FilterCharacter) {\n    characters(page: $page, filter: $filter) {\n      info {\n        count\n        pages\n        next\n        prev\n      }\n      results {\n        id\n        name\n        status\n        species\n        type\n        gender\n        origin {\n          name\n        }\n        location {\n          name\n        }\n        image\n        episode {\n          id\n          name\n        }\n        created\n      }\n    }\n  }\n': typeof types.GetCharactersTableDocument;
  '\n  query GetFilterOptions {\n    characters {\n      results {\n        status\n        species\n        gender\n      }\n    }\n  }\n': typeof types.GetFilterOptionsDocument;
  '\n  query SearchCharactersTable($name: String!) {\n    characters(filter: { name: $name }) {\n      results {\n        id\n        name\n        image\n        status\n        species\n      }\n    }\n  }\n': typeof types.SearchCharactersTableDocument;
...
const documents: Documents = {
  '\n  query GetCharactersTable($page: Int, $filter: FilterCharacter) {\n    characters(page: $page, filter: $filter) {\n      info {\n        count\n        pages\n        next\n        prev\n      }\n      results {\n        id\n        name\n        status\n        species\n        type\n        gender\n        origin {\n          name\n        }\n        location {\n          name\n        }\n        image\n        episode {\n          id\n          name\n        }\n        created\n      }\n    }\n  }\n':
    types.GetCharactersTableDocument,
  '\n  query GetFilterOptions {\n    characters {\n      results {\n        status\n        species\n        gender\n      }\n    }\n  }\n':
    types.GetFilterOptionsDocument,
  '\n  query SearchCharactersTable($name: String!) {\n    characters(filter: { name: $name }) {\n      results {\n        id\n        name\n        image\n        status\n        species\n      }\n    }\n  }\n':
    types.SearchCharactersTableDocument,
  '\n  query GetCharacters($page: Int, $filter: FilterCharacter) {\n    characters(page: $page, filter: $filter) {\n      info {\n        count\n        pages\n        next\n        prev\n      }\n      results {\n        id\n        name\n        status\n        species\n        type\n        gender\n        origin {\n          id\n          name\n          type\n          dimension\n        }\n        location {\n          id\n          name\n          type\n          dimension\n        }\n        image\n        episode {\n          id\n          name\n          episode\n          air_date\n        }\n        created\n      }\n    }\n  }\n':
